...
<div class="mission-container">
    ...
    <div class="mission-text-container">
        <div class="mission-text">
            ...
            <p class="name-span">If you want to support become a supporter then click <u><a onclick=smoothScroll() onclick=smoothScroll() ga(‘send’, ‘event’, [Animations], [Clicked], [PaymentLink]);>here!</a></u></p>
        </div>
    </div>
</div>
...
<div class="mission-main">
    <div class="text-container">
        <?php while (have_posts()) : the_post(); ?>
            <?php the_content(); ?>
        <?php endwhile; ?>
        <div class="payment-details scrollHere">
...
<div class="mission-container-mobile">
    <div class="mission-text-container-mobile">
        <div class="mission-text-mobile">
            <h1 class="big-header"><?php echo $main_header ?></h1>
            <p class="name-span">If you want to support become a supporter then click <u><a onclick=smoothScrollMobile()  ga(‘send’, ‘event’, [Animations], [Clicked], [PaymentLink]);>here!</a></u></p>
...
<div class="mission-main-mobile">
    <div class="text-container-mobile">
        <?php while (have_posts()) : the_post(); ?>
            <?php the_content(); ?>
        <?php endwhile; ?>
        <div class="payment-details scrollHereMobile">
            <H1>Payment details</H1>
            <p>Wanderdicks Ry</p>
            <p><?php echo $iban ?></p>
            <p>BIC: <?php echo $bic ?></p>
