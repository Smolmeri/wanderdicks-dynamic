...
<div class="mission-container">
    ...
    <div class="mission-text-container">
        <div class="mission-text">
            ...
            <p class="name-span">If you want to support become a supporter then click <u><a onclick="smoothScroll()">here!</a></u></p>
        </div>
    </div>
</div>
...
<div class="mission-container-mobile">
    <div class="mission-text-container-mobile">
        <div class="mission-text-mobile">
            <h1 class="big-header"><?php echo $main_header ?></h1>
            <p class="name-span">If you want to support become a supporter then click <u><a onclick="smoothScrollMobile()">here!</a></u></p>
